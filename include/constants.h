...
public:
  ...
  static constexpr double   LAMBDA_DEFAULT        = 0.4;
  static constexpr unsigned SOURCES_DEFAULT       = 16;
  static constexpr unsigned CONSUMERS_DEFAULT     = 12;
  static constexpr unsigned BUFFER_DEFAULT        = 128;
